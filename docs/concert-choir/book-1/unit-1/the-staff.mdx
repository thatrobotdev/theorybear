...
<figure class="card card__body" style={{display: 'inline-flex', float: 'right', width: '450px'}}>
  <div class="darkmodeWhiteBackground">
    <StaffLinesSpacesSVG 
      alt="A typical five-line staff with five equally spaced horizontal lines on a white background"
      className="card__image fillWhite"
...
<Admonition type="tip">
  Questions 1-3 cover the basics of the staff. [Questions 4-5 are covered in "Treble (G) Clef and Bass (F) Clef"](/docs/concert-choir/book-1/unit-1/treble-bass-clef). Use the "Print" button to print the worksheet and write on it. Some browsers have a "Draw" button that allows you to mark up the PDF digitally.
</Admonition>
