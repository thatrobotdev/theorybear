...
<Admonition type="tip">
  Questions 1-3 cover the basics of the staff. <a href="./D">Questions 4-5 are covered in 1.D.</a> Use the "Print" button to print the worksheet and write on it. Some browsers have a "Draw" button that allows you to mark up the PDF digitally.
</Admonition>
